...
python3 -m sglang.launch_server \
        ...
        --chunked-prefill-size -1 --max-prefill-tokens 258000 \
        --trust-remote-code \
        --mamba-scheduler-strategy extra_buffer \
	--host 127.0.0.1 --max-running-requests 16 --max-mamba-cache-size 80 \
        --mem-fraction-static 0.6 \
        --port 8001 \
        --cuda-graph-bs 2 6 8 10 11 12 14 16 \
        --enable-multimodal \
