...
class TestNPUBalance(TestAscendPerfMultiNodePdSepTestCaseBase):
    ...
    def parse_worker_requests(self, metrics):
        ...
        total_requests = metrics['smg_http_requests_total{method="POST",path="/v1/chat/completions"}']
    ...
    def test_throughput_with_prefill_stats(self):
        ...
        prefill_requests_before, decode_requests_before = self.parse_worker_requests(router_metrics_before)
        self.run_throughput()
