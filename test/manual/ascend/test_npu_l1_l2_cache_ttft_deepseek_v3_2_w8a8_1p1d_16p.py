...
class TestDeepSeekV32HierarchicalCacheHit(TestAscendMultiNodePdSepTestCaseBase):
    ...
    def test_hierarchical_cache_hit_and_ttft_reduce(self):
        ...
        try:
            ...
            ttft_1, cached_tokens_1 = self.send_long_prompt_request(prompt_token_len=600, max_new_tokens=1)
            self.assertEqual(cached_tokens_1, 0, msg="First request cached tokens should be 0")

            ttft_2, cached_tokens_2 = self.send_long_prompt_request(prompt_token_len=600, max_new_tokens=1)
