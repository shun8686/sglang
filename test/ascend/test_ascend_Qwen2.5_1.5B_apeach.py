...
MODELS = [
   ("/data/l30079981/weights/Qwen2.5-1.5B-apeach",1,4e-2),
   # ("/data/l30079981/weights/Qwen2.5-Math-RM-72B",4,4e-2),
   # ("/data/ascend-ci-share-pkking-sglang/modelscope/hub/models/Shanghai_AI_Laboratory/internlm2-7b-reward",1,4e-2),
...
#    model_path = "/data/ascend-ci-share-pkking-sglang/modelscope/hub/models/Shanghai_AI_Laboratory/internlm2-7b-reward"
