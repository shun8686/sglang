...
if is_npu():
    MODELS = [
       ("/data/ascend-ci-share-pkking-sglang/modelscope/hub/models/AI-ModelScope/clip-vit-large-patch14-336",1,0.22)
    ]
else:
    MODELS = [
        ("AI-ModelScope/clip-vit-large-patch14-336", 1, 1e-5)
    ]
