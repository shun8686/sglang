...
class TestGemma(CustomTestCase):
    """Testcase:This test case verifies that the reward scores generated by the AI-ModelScope/Skywork-Reward-Gemma-2-27B-v0.2
     model in the SGLang framework closely match those produced by the Hugging Face implementation for different conversational responses.
