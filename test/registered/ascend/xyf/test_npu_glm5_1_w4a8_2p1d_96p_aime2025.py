...
class TestNPUGLM5_1_W4A8_2P1D_96P_AIME2025(TestAscendAccuracyPdSepTestCaseBase):
    """Test NPU accuracy for GLM-5.1-w4a8 2p1d_96p PD separation AIME2025"""
    ...
    def test_npu_glm5_1_w4a8_2p1d_96p_aime2025(self):
        """Run NPU accuracy test for GLM-5.1-w4a8 2p1d_96p AIME2025"""
        self.run_accuracy()
