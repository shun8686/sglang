...
class TestNPUQwen3_5_397B_W4A8_1P1D_16P_In64k_Out1k_50ms(TestAscendPerformancePdSepTestCaseBase):
    """Test NPU performance for Qwen3.5-397B-w4a8 1p1d_16p PD separation in64k out1k"""
    ...
    def test_npu_qwen3_5_397b_w4a8_1p1d_16p_in64k_out1k_50ms(self):
