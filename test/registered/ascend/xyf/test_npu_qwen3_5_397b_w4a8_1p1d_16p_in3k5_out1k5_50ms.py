...
class TestNPUQwen3_5_397B_W4A8_1P1D_16P_In3k5_Out1k5_50ms(TestAscendPerformancePdSepTestCaseBase):
    """Test NPU performance for Qwen3.5-397B-w4a8 1p1d_16p PD separation in3k5 out1k5"""
    ...
    def test_npu_qwen3_5_397b_w4a8_1p1d_16p_in3k5_out1k5_50ms(self):
