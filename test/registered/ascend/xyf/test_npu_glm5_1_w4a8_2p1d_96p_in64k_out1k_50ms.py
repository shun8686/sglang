...
class TestNPUGLM5_1_W4A8_2P1D_96P_In64k_Out1k_50ms(TestAscendPerformancePdSepTestCaseBase):
    """Test NPU performance for GLM-5.1-w4a8 2p1d_96p PD separation in64k out1k"""
    ...
    def test_npu_glm5_1_w4a8_2p1d_96p_in64k_out1k_50ms(self):
