...
MODELS = [
    ...
    SimpleNamespace(model="Qwen/Qwen/Qwen3-VL-30B-A3B-Instruct", mmmu_accuracy=0.55),
    SimpleNamespace(model="OpenBMB/MiniCPM3-4B", mmmu_accuracy=0.52),
    SimpleNamespace(model="ZhipuAI/GLM-4.6V-Flash", mmmu_accuracy=0.68),
]
