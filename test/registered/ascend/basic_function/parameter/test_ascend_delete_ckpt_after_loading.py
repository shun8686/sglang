...
from sglang.test.ascend.test_ascend_utils import QWEN2_0_5B_INSTRUCT_WEIGHTS_PATH, QWEN3_0_6B_WEIGHTS_PATH
...
class TestAscendDeleteCkptAfterLoading(CustomTestCase):
    ...
    def setUpClass(cls):
        ...
        if os.path.exists(cls.back_up_model):
            shutil.rmtree(cls.back_up_model)
        shutil.copytree(cls.model, cls.back_up_model)
