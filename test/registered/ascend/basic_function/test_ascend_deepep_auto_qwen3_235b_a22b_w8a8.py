...
class TestDeepEpAutoQwen3235B(CustomTestCase):
    """Testcase:Test the Qwen3-235B-A22B-W8A8 model with DeepEP's auto mode enabled, and verify that there is no drop in accuracy compared to when DeepEP is not enabled.
