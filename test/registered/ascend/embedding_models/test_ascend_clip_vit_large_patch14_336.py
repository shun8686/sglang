...
class TestClipVitLargePatch14(CustomTestCase):
    """Testcase:This test case verifies that the embeddings generated by the AI-ModelScope/clip-vit-large-patch14-336 model
     in the SGLang framework closely match those produced by the Hugging Face implementation under various configurations.
