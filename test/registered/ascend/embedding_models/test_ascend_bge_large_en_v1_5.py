...
class TestBgeLargeEn(CustomTestCase):
    """Testcase:This test case verifies that the embeddings generated by the BAAI/bge-large-en-v1.5 model in the
    SGLang framework closely match those produced by the Hugging Face implementation under various configurations.
