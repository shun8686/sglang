...
class TestNPUKimiK2_5_W4A8_1P1D_16P_In128k_Out1k_50ms(TestAscendPerfMultiNodePdSepTestCaseBase):
    ...
    def test_npu_kimi_k2_5_w4a8_1p1d_16p_in128k_out1k_50ms(self):
        """Run NPU performance test for 1P+1D 16p with 128k input, 1k output, TPOT=50ms"""
        self.run_throughput()
