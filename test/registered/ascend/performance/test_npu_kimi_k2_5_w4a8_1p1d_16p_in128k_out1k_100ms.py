...
class TestNPUKimiK2_5_W4A8_1P1D_16p_In128k_Out1k_100ms(
    TestAscendPerfMultiNodePdSepTestCaseBase
):
    """Test NPU performance for Kimi-K2.5-w4a8 1P+1D 16p: input_len=131072, output_len=1024, TPOT=100ms"""
    ...
    def test_npu_kimi_k2_5_w4a8_1p1d_16p_in128k_out1k_100ms(self):
        """Run NPU performance test for 1P+1D 16p with 128k input, 1k output, TPOT=100ms"""
        self.run_throughput()
