...
class TestNPUKimiK2_5_W4A8_1P1D_16P_In256k_Out1k_50ms(TestAscendPerfMultiNodePdSepTestCaseBase):
    """Test NPU performance for Kimi-K2.5-w4a8 1P+1D 16p: input_len=260096, output_len=1024, TPOT=50ms"""
    ...
    def test_npu_kimi_k2_5_w4a8_1p1d_16p_in256k_out1k_50ms(self):
        """Run NPU performance test for 1P+1D 16p with 256k input, 1k output, TPOT=50ms"""
        self.run_throughput()
