...
QWEN3_30B_A3B_W8A8_MODEL_PATH = os.path.join(MODEL_WEIGHTS_DIR, "Qwen/Qwen3-30B-A3B-w8a8")
...
QWEN3_32B_W8A8_MINDIE_WEIGHTS_PATH = os.path.join(MODEL_WEIGHTS_DIR, "aleoyang/Qwen3-32B-w8a8-MindIE")
