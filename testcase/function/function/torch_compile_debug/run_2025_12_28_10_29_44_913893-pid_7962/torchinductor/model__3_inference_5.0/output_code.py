...
# kernel path: /tmp/torchinductor_root/w4/cw4vmtftmhsninviu5wp4mfkiirgld7j56jubjtw2dusiozmk5aa.py
...
@npu_triton_heuristics.pointwise_npu_index(
    ...
    inductor_meta={'grid_type': 'GridNpu', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_clone_0', 'mutated_arg_names': [], 'backend_hash': '97c27bc83513d430fa5df894c0f9efe76633fb52aa751e767e86f4240dce3140', 'split_axis': [0], 'tiling_axis': [0, 1], 'axis_names': ['y0', 'x1'], 'low_dims': {0, 1}, 'numof_reduction_axis': 0, 'split_axis_dtype': torch.int32, 'dual_reduction': False, 'traced_graph_hash': 'TRACED_GRAPH_HASH', 'traced_graph_dir': 'TRACED_GRAPH_DIR', 'store_cubin': False, 'force_disable_caches': False, 'profile_bandwidth_with_do_bench_using_profiling': False},
...
# kernel path: /tmp/torchinductor_root/ri/crij6ncrtkiagzgkusaa2imufocxnncrbfbwh4ue2phalmrhxcks.py
...
# kernel path: /tmp/torchinductor_root/ug/cugln3h5qwpwufmdpx7vszjk7nnrn6zvrauzpzo7mu2i3hnhzh4p.py
