...
# kernel path: /tmp/torchinductor_root/w2/cw2p6g3ahvsfadvik5to2f4h4j5n2bgpnrprapj5wau36o4jbnxj.py
...
@npu_triton_heuristics.pointwise_npu_index(
    ...
    inductor_meta={'grid_type': 'GridNpu', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_clone_0', 'mutated_arg_names': [], 'backend_hash': '2856bf7fd69d5b60b9f1ef151e0c171106544114bfcb4596a2093bc4d8a29f65', 'split_axis': [0], 'tiling_axis': [0, 1], 'axis_names': ['y0', 'x1'], 'low_dims': {0, 1}, 'numof_reduction_axis': 0, 'split_axis_dtype': torch.int32, 'dual_reduction': False, 'traced_graph_hash': 'TRACED_GRAPH_HASH', 'traced_graph_dir': 'TRACED_GRAPH_DIR', 'store_cubin': False, 'force_disable_caches': False, 'profile_bandwidth_with_do_bench_using_profiling': False},
...
# kernel path: /tmp/torchinductor_root/ho/chox33ed62qdxnlx5p7ldnjmg42zmc6rvchxelayrtnpjh2wqdab.py
...
# kernel path: /tmp/torchinductor_root/b5/cb5w2pxtzbbz4ckkomru5d2c6qgl7mc7ffblardpt54slscymlw6.py
...
@npu_triton_heuristics.pointwise_npu_index(
    ...
    inductor_meta={'grid_type': 'GridNpu', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_eq_masked_fill_2', 'mutated_arg_names': [], 'backend_hash': '2856bf7fd69d5b60b9f1ef151e0c171106544114bfcb4596a2093bc4d8a29f65', 'split_axis': [0], 'tiling_axis': [0], 'axis_names': ['x0'], 'low_dims': {0}, 'numof_reduction_axis': 0, 'split_axis_dtype': torch.float32, 'dual_reduction': False, 'traced_graph_hash': 'TRACED_GRAPH_HASH', 'traced_graph_dir': 'TRACED_GRAPH_DIR', 'store_cubin': False, 'force_disable_caches': False, 'profile_bandwidth_with_do_bench_using_profiling': False},
    min_elem_per_thread=0
)
@triton.jit
